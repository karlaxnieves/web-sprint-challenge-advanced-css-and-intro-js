  ...
  for (let i = 0; i < array.length; i++) {
    if (array[i] === object) {
      array.push({
        id: 20,
        name: 'Karla Nieves',
        years: 'July 15, 1993 - February 19, 2021',
        genre: 'Web Design',
        nationality: 'Mexican',
        bio: 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Sequi accusantium voluptate voluptatibus, architecto, suscipit assumenda animi iusto esse ratione recusandae illum provident vel quidem! Magnam atque illo dolorum mollitia eius?'
      });
    }
  }
  return array;
